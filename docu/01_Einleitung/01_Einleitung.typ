...
Nachzuvollziehen, welcher der beiden Bereiche, kommerzielle oder private Flüge, einen größeren Einfluss auf die Umwelt haben ist allerdings garnicht so einfach.
...
Diesem Problem wollten wir uns annähern. Uns war bekannt, dass es möglich ist über Dienste wie flightradar24 @flightradar24 live Flugzdaten zu verfolgen. Unsere Annahme war, dass man eine API eines solchen Dienstes nutzen könne, um mittel Live-Daten und historischen Daten einen Flugtracker für die reichsten Menschen der Welt zu erstellen. Dieser sollte Flugdaten dreidimensional darstellen, indem Flugzeuge über eine Miniaturversion der Erde fliegen. Dieser Tracker sollte sowohl am Computer als auch auf einem Smartphone mittels Vuforia Image Tracking im 2D- sowie AR-Raum dargestellt werden können. Darauf aufbauend hätten in Zukunft dann weitere private Flüge sowie kommerzielle Flüge und Frachtverkehr ebenfalls dargestellt werden können.
Der Grund dafür, dass wir uns zuerst auf die Gruppe der reichsten Menschen der Welt konzentrieren wollten war vor allem die Neugierde dafür, ob so etwas möglich ist, Flugdaten unter diese Gruppe fallender Menschen zu tracken und zu visualisieren, als auch politische Voreingenommenheit.

Vorallem aufgrund der Schwierigkeit Flugdaten generell allumfänglich abzufragen sowie die Flugzeuge spezifischer Personen wie z.B. Elon Musk, Jeff Bezos oder Tailor Swift zu identifizieren, mussten wir unsere Umsetzung anpassen. Diese und weitere Problemstellungen werden im Kapitel  @Problemlösung ausführlicher erläutert. Wir haben uns dazu entschieden den zu Anfangs als in Aussicht stehenden Punkt der "weiteren privaten Flüge" in den Fokus zu stellen udn mussten uns aufgrund von Zeitknappheit auf eine 2D-Anwendung beschränken.
