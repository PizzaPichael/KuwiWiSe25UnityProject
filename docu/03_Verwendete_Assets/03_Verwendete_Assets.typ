...
- *FlightComputerImage* @flightcomputer-thumbnail: Abbildung eines Flugcomputerbildschirms, wird genutzt um Flugdaten eines Flugzeuges nach Auswahl des Flugzeuges darzustellen.
- *Milkyway Skybox* @sky-box: Bild eines Milchstraßen Panoramas, das, auf eine Kugel projiziert, als Skybox der Szene genutzt wird.
